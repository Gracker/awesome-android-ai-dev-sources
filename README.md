...
## 🔥 最近收录
> 每日自动发现，LLM 评估后收录 · 更新于 2026-06-15

| 信息源 | 领域 | 描述 |
|--------|------|------|
| **Mobile Architect** [𝕏](https://x.com/mobilearchitect) | 通用 | 专注于移动应用架构设计的大型应用迁移专家，分享微服务架构实践和经验 |
| **Tech Writer** [𝕏](https://x.com/techwriter) | android | Android内存优化专家，分享生产环境内存管理最佳实践和性能优化技巧 |
| **Cloud Evangelist** [𝕏](https://x.com/cloudevangelist) | 通用 | 云架构和serverless专家，分享在大规模生产环境中节省数百万成本的架构模式 |
| **AI Researcher** [𝕏](https://x.com/airesearcher) | AI | AI联邦学习研究专家，专注于通信优化的联邦学习算法突破 |
| **John Doe** [𝕏](https://x.com/johndoe) | AI | 机器学习专家，专注于自然语言处理和transformer架构的创新突破 |
| **程序员码歌** [💎](https://juejin.cn/user/764915820529831/posts) | Android | AI工具和技能分享专家，热门Android开发技能和工具使用教程 |
| **黄林晴** [💎](https://juejin.cn/user/3985057546510423/posts) [💬](Android技术圈) | Android | Android技术专家，专注于Android新特性分析和架构原理深入解析 |
| **恋猫de小郭** [💎](https://juejin.cn/user/817692379985752/posts) | 通用 | AI和开发工具专家，跨平台框架对比和IDE未来趋势分析 |
| **Randy's Blog** [🌐](https://lutaonan.com/blog/ai-writing/) | 通用 | 深度技术博客，专注于AI与写作、思维工具、Copilot写作辅助等前沿技术实践 |
| **jeremyphoward** [𝕏](https://x.com/jeremyphoward) | AI | 高效注意力机制研究专家，LLM效率优化领域重要贡献者 |
...
<a id="ai"></a>
## 🧠 AI & LLM
*AI 领域精选资源（详见 awesome-ai-field-notes）* · 54 个源
...
| **Randy's Blog** [🌐](https://lutaonan.com/blog/ai-writing/) | 深度技术博客，专注于AI与写作、思维工具、Copilot写作辅助等前沿技术实践 |
...
1. Fork 本仓库
2. 编辑 `data/entries.json`，按 schema 添加新条目
3. 运行 `python3 scripts/generate-readme.py` 重新生成 README
...
<p align="center">Licensed under the terms of the <a href="https://github.com/Gracker/awesome-android-ai-dev-sources/blob/main/LICENSE">LICENSE</a> file.</p>
